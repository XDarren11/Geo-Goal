...
export default function RequestNewCodeView() {
  const defaultValues: RequestConfirmationCodeForm = { email: "" };
  ...
  return (
    <>
      ...
      <p className="mt-4 text-lg text-[var(--geo-text-muted)]">
        Escribe tu email para recibir{" "}
        <span className="font-bold text-geo-green">un nuevo código</span>
      </p>
      ...
      <nav className="mt-6 flex flex-col gap-3 text-center">
        ...
        <Link to="/auth/forgot-password" className="text-[var(--geo-text-muted)] hover:text-geo-green transition-colors">
