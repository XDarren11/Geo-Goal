...
export function buildLeagueMediator(leagueService: ILeagueService): Mediator {
  ...
  mediator.register(
    "league.getTrainerTeams",
    new GetTrainerTeamsHandler(leagueService)
  );
  mediator.register("league.getTeams", new GetTeamsLeagueHandler(leagueService));
  mediator.register(
    "league.removeTeam",
    new RemoveTeamFromLeagueHandler(leagueService)
  );
  mediator.register(
    "league.generateFixture",
    new GenerateFixtureHandler(leagueService)
  );
  mediator.register("league.getFixture", new GetLeagueFixtureHandler(leagueService));
  mediator.register(
    "league.getFixtureWithLocations",
    new GetFixtureWithLocationsHandler(leagueService)
  );
  ...
  mediator.register(
    "league.getLeagueMatchesGrouped",
    new GetLeagueMatchesGroupedHandler(leagueService)
  );
  mediator.register(
    "league.restructureFixture",
    new RestructureLeagueFixtureHandler(leagueService)
  );
